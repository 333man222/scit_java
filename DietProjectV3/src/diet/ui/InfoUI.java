...
public class InfoUI {
	...
	public InfoUI() {
		...
		while(true) {
			...
			case "4" :
				System.out.println("\n [[ 운동 확인 ]]");
				System.out.println("=================");
				System.out.println("1. 운동 기록 입력");
				System.out.println("2. 타입별 운동 기록 조회");
				System.out.println("3. 전체 운동 기록 조회");
				System.out.println("4. 운동 기록 수정");
				System.out.println("5. 운동 기록 삭제");
				System.out.println("6. 메뉴 돌아가기");
				System.out.println("0. 종                 료");	
				System.out.println("=======================");
				System.out.print("> 번호 입력 : ");
	...
	private void updateExer() {
		...
		String  exerstat, exerdate;

		int seq, exertime;

		try {
			System.out.print("> 운동 번호 입력 : ");
			seq = keyin.nextInt();
		} catch (Exception e) {
		...
		Exer exe = new Exer(ex.getCheck_seq(), null, null, null, exerstat, exertime, exerdate);
	...
	private void searchExer() {
		...
		List<Exer> list = exer.searchExer(searchItem, searchWord);
		if(list == null) {
	...
	private void insertExer() {
		...
		if (recom == null) {
			System.out.println("**추천운동 번호를 먼저 입력해 주세요");
			return;
		}
		...
		Exer ser = new Exer(0, d.getUser_id(),recom.getRecom_id(), recomexer,exerstat, t, null);
