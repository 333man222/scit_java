...
public class Exer {
	...
	public Exer() {}
	public Exer(int check_seq, String user_id, String recom_id, String recom_exer, String exer_status, int exer_time,
			String exer_date) {
		super();
	...
	public String toString() {
		return "Exer [check_seq=" + check_seq + ", user_id=" + user_id + ", recom_id=" + recom_id + ", recom_exer="
				+ recom_exer + ", exer_status=" + exer_status + ", exer_time=" + exer_time + ", exer_date=" + exer_date
				+ "]";
	}
